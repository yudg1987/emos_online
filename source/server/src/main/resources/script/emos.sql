...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='行为表';

/*Data for the table `tb_action` */

insert  into `tb_action`(`id`,`action_code`,`action_name`) values (1,'1','超级管理员'),(2,'2','会议审批'),(3,'3','部门查询'),(4,'4','新增会议'),(5,'5','更新会议'),(6,'6','员工查询'),(7,'7','角色查询'),(8,'8','角色新增'),(9,'9','角色更新');
...
CREATE TABLE `tb_checkin` (
  ...
  KEY `idx_status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='签到表';

/*Data for the table `tb_checkin` */

insert  into `tb_checkin`(`id`,`user_id`,`address`,`country`,`province`,`city`,`district`,`status`,`risk`,`date`,`create_time`) values (1,103,'安徽省合肥市蜀山区石镜北路','中国','安徽省','合肥市','蜀山区',2,1,'2022-05-08','2022-05-08 16:40:30');
...
) ENGINE=InnoDB AUTO_INCREMENT=1113 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

/*Data for the table `tb_dept` */

insert  into `tb_dept`(`id`,`dept_name`) values (1111,'技术部'),(1112,'销售部');
...
insert  into `tb_employee`(`code`,`name`,`tel`,`email`,`hiredate`,`role`,`dept_id`,`sex`,`state`) values (1000,'俞登刚','17368837302','398305246@qq.com','2022-05-02','1',1111,'男',1),(1001,'惠清华','19965412826','378587392@qq.com','2022-05-02','1',1111,'女',1),(1002,'程晨','11111111','398305246@qq.com','2022-05-02','1',1111,'男',1),(1003,'刘建','11111111','398305246@qq.com','2022-05-02','1',1111,'男',1),(1004,'刘庆芬','15555169845','747694700@qq.com','2021-02-12','[1]',1112,'男',0),(1005,'刘庆峰','111111','11111','2021-02-12','[3]',1112,'男',0);
...
CREATE TABLE `tb_meeting` (
  ...
  KEY `idx_status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='会议表';

/*Data for the table `tb_meeting` */

insert  into `tb_meeting`(`id`,`uuid`,`title`,`creator_id`,`date`,`place`,`start`,`end`,`type`,`members`,`desc`,`instance_id`,`status`,`create_time`) values (2,'34324','周会',1,'2022-05-20','办公室','09:00:00','12:00:00',2,'[105, 106]','周会','1',4,'2022-05-18 14:00:00'),(8,'feb9ca2d39b74c838cd4a7891827a084','关于广德微信小程序需求的讨论会',1,'2022-05-16',NULL,'09:30:00','11:30:00',1,'[105, 106, 108]','关于广德微信小程序需求的讨论会',NULL,1,'2022-05-15 20:50:51'),(9,'1315004cbd6f43ad97bfec1ad8657902','广德需求讨论会',1,'2022-05-15',NULL,'21:33:00','22:33:00',1,'[1, 105, 108]','会议内容',NULL,3,'2022-05-15 21:04:40');
...
insert  into `tb_meeting_approval`(`id`,`uuid`,`last_user`,`members`,`approvals`) values (2,'1315004cbd6f43ad97bfec1ad8657902',1,'[1]','[1]');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='模块资源表';

/*Data for the table `tb_module` */

insert  into `tb_module`(`id`,`module_code`,`module_name`) values (1,'1','超级管理员'),(2,'2','会议管理'),(3,'3','部门管理'),(4,'4','员工管理');
...
insert  into `tb_permission`(`id`,`permission_name`,`module_id`,`action_id`) values (1,'WORKFLOW:APPROVAL',2,2),(2,'ROOT',1,1),(3,'DEPT:SELECT',3,3),(4,'MEETING:INSERT',2,4),(5,'MEETING:UPDATE',2,5),(6,'EMPLOYEE:SELECT',4,6),(7,'ROLE:SELECT',5,7),(8,'ROLE:INSERT',5,8),(9,'ROLE:UPDATE',5,9);
...
insert  into `tb_role`(`id`,`role_name`,`permissions`) values (1,'超级管理员','[1, 2, 3, 4, 5, 6]'),(3,'普通员工','[]');
...
CREATE TABLE `tb_user` (
  ...
  KEY `idx_status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=109 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户表';

/*Data for the table `tb_user` */

insert  into `tb_user`(`id`,`open_id`,`nickname`,`photo`,`name`,`sex`,`tel`,`email`,`hiredate`,`role`,`root`,`dept_id`,`status`,`create_time`) values (1,'oIGHs5BmHK2ZzVP5brSMo9Er8fIw','微信用户','http://106.13.6.212:8888/group1/M00/00/00/wKgABGJruxaARh8KAAAdGOcemSk658.png','俞登刚','男','17368837302','398305246@qq.com','2022-01-01','[1]',1,1111,1,'2022-05-15 19:57:55'),(105,'oIGHs5ANdVuZojq5sa9N-oBPmj_E','微信用户','http://106.13.6.212:8888/group1/M00/00/00/wKgABGJruxaARh8KAAAdGOcemSk658.png','惠清华','男','19965412826','378587392@qq.com','2022-05-02','[3]',0,1111,1,'2022-05-11 09:02:32'),(108,'oIGHs5CCcNO5wAihntFrggmcr7ns','微信用户','http://106.13.6.212:8888/group1/M00/00/00/wKgABGJruxaARh8KAAAdGOcemSk658.png','刘建','男','11111111','398305246@qq.com','2022-05-02','[3]',0,1111,1,'2022-05-13 11:48:49');
