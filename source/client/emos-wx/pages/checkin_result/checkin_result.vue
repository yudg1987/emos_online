<template>
	<view class="page">
		...
		<view class="result-container">
			<view class="left">
				<image class="icon-timer" src="http://124.221.192.169:8888/group1/M00/00/00/wKgABGJ2Y3uAQINQAAAMkT5t9zQ047_big.png" mode="widthFix"></image>
				<image class="icon-timer" src="http://124.221.192.169:8888/group1/M00/00/00/wKgABGJ2Y3uAQINQAAAMkT5t9zQ047_big.png" mode="widthFix"></image>
				<view class="line">
			...
			<view class="right">
				...
				<view class="row">
					...
					<image class="icon-small" src="http://124.221.192.169:8888/group1/M00/00/00/wKgABGJ2Y6qAUsUoAAAIb_AylxM377_big.png" mode="widthFix"></image>
				...
				<view class="row">
					<image class="icon-small" src="http://124.221.192.169:8888/group1/M00/00/00/wKgABGJ2Y8OAZnf-AAAErW4-O6A587_big.png" mode="widthFix"></image>
		...
		<view class="checkin-report">
			<image class="big-icon" src="http://124.221.192.169:8888/group1/M00/00/00/wKgABGJ2Y9-ASOM1AAEI4MK_ziQ408_big.png" mode="widthFix"></image>
			...
			<view class="calendar-container">
				<view class="calendar" v-for="(one,index) in weekCheckin" :key="index">
					<image class="calendar-icon" src="http://124.221.192.169:8888/group1/M00/00/00/wKgABGJ2Y_eAYrh_AAAEicfJ9SA880_big.png" v-if="one.type != '节假日'" mode="widthFix"></image>
					<image class="calendar-icon" src="http://124.221.192.169:8888/group1/M00/00/00/wKgABGJ2ZAmAYG_YAAAEWjSGZeM207_big.png" v-if="one.type == '节假日'" mode="widthFix"></image>
