<template>
	<view>
		<uni-list>
			<uni-list-item thumb="http://124.221.192.169:8888/group1/M00/00/00/wKgABGJ2ZGaAJdFPAAADkrg68qA248_big.png" v-for="one in fileList" :note="one.fileSize" :title="one.key"
